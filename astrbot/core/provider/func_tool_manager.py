...
class FunctionToolManager:
    def __init__(self) -> None:
        ...
        global _global_func_tool_manager_instance
        _global_func_tool_manager_instance = self
...
# 全局单例引用，供无法通过依赖注入获取实例的模块使用（如 CLI 适配器）
_global_func_tool_manager_instance: "FunctionToolManager | None" = None


def get_func_tool_manager() -> "FunctionToolManager | None":
    """获取全局 FunctionToolManager 实例。"""
    return _global_func_tool_manager_instance
